...
from feature_selection_timeseries.author_feature_selection.dynamic_selection_main.dynamic_selection.utils import generate_uniform_mask, restore_parameters
...
class MaskingPretrainer(nn.Module):
    ...
    def evaluate(self, loader, metric):
        ...
        # added sept 12
        print("self.model.parameters()F: ", self.model.parameters())
